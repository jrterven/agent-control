...
| Voice | Configure one owner-scoped ElevenLabs key for Scribe v2 Realtime dictation and Flash v2.5 response playback. Choose an account voice, listen while an answer streams, or replay any completed response with play/pause, stop and speed controls. Native keyboard dictation remains the free fallback. |
