...
| Agents | Discover Newton, Jarvis and other provider profiles; use their verified tools and administration capabilities; create a clean isolated Hermes profile while following live setup progress; and, on compatible Hermes revisions, move or permanently delete an idle agent through the native profile contract. |
