const es = {
  adminConfig: {
    ...
    management: {
      ...
      moveConnectionRequired: "Mantén ambos equipos conectados para mover el agente.", destinationUnavailable: "Selecciona otro gateway disponible", movingProgress: "Moviendo el agente y verificando el destino. Mantén ambos equipos conectados hasta que termine.",
...
const en = {
  adminConfig: {
    ...
    management: {
      ...
      moveConnectionRequired: "Keep both computers connected to move the agent.", destinationUnavailable: "Select another available gateway", movingProgress: "Moving the agent and verifying the destination. Keep both computers connected until it finishes.",
...
const fr = {
  adminConfig: {
    ...
    management: {
      ...
      moveConnectionRequired: "Gardez les deux ordinateurs connectés pour déplacer l’agent.", destinationUnavailable: "Sélectionnez une autre gateway disponible", movingProgress: "Déplacement de l’agent et vérification de la destination. Gardez les deux ordinateurs connectés jusqu’à la fin.",
...
const de = {
  adminConfig: {
    ...
    management: {
      ...
      moveConnectionRequired: "Lassen Sie beide Computer verbunden, um den Agenten zu verschieben.", destinationUnavailable: "Anderes verfügbares Gateway auswählen", movingProgress: "Der Agent wird verschoben und das Ziel geprüft. Lassen Sie beide Computer bis zum Abschluss verbunden.",
...
const pt = {
  adminConfig: {
    ...
    management: {
      ...
      moveConnectionRequired: "Mantenha os dois computadores conectados para mover o agente.", destinationUnavailable: "Selecione outro gateway disponível", movingProgress: "Movendo o agente e verificando o destino. Mantenha os dois computadores conectados até terminar.",
