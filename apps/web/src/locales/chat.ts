export const chatResources = {
  es: {
    ...
    activity: {
      ...
      deleteDescription: "Borra la conversación en la infraestructura Hermes existente. Requiere escribir su ID exacto.",
      ...
      deleteDialogDescription: "Esto borra la conversación de Hermes, no solo su referencia en Control. Escribe el ID persistente exacto para continuar.",
      persistentId: "ID persistente:",
      cancel: "Cancelar",
      deleting: "Eliminando…"
    }
  },
  en: {
    chat: {
      ...
      messagePlaceholder: "Message {{agent}}…", offlineDraft: "Offline draft", stop: "Stop", running: "Running", sendMessage: "Send message",
      ...
      creating: "Creating…", newChat: "New chat", waitingForResponse: "{{agent}} is waiting for your response", typing: "{{agent}} is typing", promptUnavailable: "This profile did not advertise message sending.", profileReadOnly: "This profile is protected in read-only mode.", chooseTestEnvironment: "To write, select the test environment."
    },
    approvals: {
