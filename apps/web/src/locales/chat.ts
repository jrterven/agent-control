export const chatResources = {
  ...
  en: {
    chat: {
      ...
      creating: "Creating…", newChat: "New chat", waitingForResponse: "{{agent}} is waiting for your response", typing: "{{agent}} is typing", promptUnavailable: "This profile did not advertise message sending.", profileReadOnly: "This profile is protected in read-only mode.", voiceNote: "Voice note", voiceNoteNumber: "Voice note {{number}}", playVoiceNote: "Play voice note", audioUnsupported: "Your browser cannot play this voice note.", chooseTestEnvironment: "To write, select the test environment."
    },
    approvals: {
