  ...
  es: {
    chat: {
      ...
      emailReferences: {
        ...
        openError: "No se pudo abrir el correo. Inténtalo de nuevo.",
        openInGmailApp: "Abrir en la app de Gmail",
        openInBrowser: "Abrir en navegador",
        preparingOpen: "Preparando Gmail…",
        retryOpen: "Reintentar apertura",
        emptyBody: "Este correo no tiene contenido de texto disponible.",
        citedNotVerified: "Referencia de {{agent}} · confirma en tu buzón",
        summaryPreview: "Resumen proporcionado por el agente; no es el cuerpo completo del correo.",
