...
export const visionInteractionCopy = (language: string) => language.toLowerCase().startsWith("es") ? {
  ...
  clarify: "¿Te refieres a lo que muestra la cámara? Precisa tu pregunta en el chat.", failed: "No se pudo obtener una observación actual. Revisa los controles de la cámara.",
} : {
  ...
  clarify: "Do you mean what the camera is showing? Clarify your question in chat.", failed: "A current observation could not be obtained. Check the camera controls.",
};
