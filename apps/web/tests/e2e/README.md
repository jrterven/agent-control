...
`npm run test:e2e:chromium` ejecuta la matriz mínima de aceptación en 390×844, 1024×1366 y 1440×900. La suite completa añade Firefox de escritorio y WebKit en móvil y escritorio. `PLAYWRIGHT_BASE_URL` permite apuntar las pruebas a un servidor productivo ya iniciado sin levantar `vite preview`.
